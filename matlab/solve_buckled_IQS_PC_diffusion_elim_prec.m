function [u_end, X,t,y,T] = solve_buckled_IQS_PC_diffusion_elim_prec(u,X,dt_macro,time_end,Told)
...
for iter = 1: max_iter_iqs
    ...
    [u_end, auxphi] = solve_buckled_TD_diffusion_elim_prec(u_beg,dt_macro,time_end,Told);
