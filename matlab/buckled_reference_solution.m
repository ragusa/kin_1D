function  [varargout] = buckled_reference_solution( t_end, u0)
...
options = odeset('RelTol',1e-8,'AbsTol',1e-8,'InitialStep',1e-8,'Stats','on','MaxStep',1e-1,'Stats','off');
% options = odeset('RelTol',1e-4,'AbsTol',1e-4);
[t_ref,u_arr]=ode15s(@buckled_residual_TD_diffusion,[0 t_end],u0,options);
u_arr=u_arr';
