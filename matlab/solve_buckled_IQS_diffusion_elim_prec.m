function [u_shape, X,t,y,T] = solve_buckled_IQS_diffusion_elim_prec(u_shape,X,dt_macro,time_end,Told)
...
for iter = 1: max_iter_iqs
    ...
    for i=1:rk.s
        ...
        A    = assemble_buckled_mass(dat.siga ,ti,T);
...
T = compute_temp_IQS(Told,[shape_beg shape_end],t,y);