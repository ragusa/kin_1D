...
\begin{figure}[h]
\includegraphics[width=0.9\linewidth]{figures/AnalyticalvsBE_Precursor_Power.png}
%\caption{IQS method solution process}
\label{fig:IQS}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=0.9\linewidth]{figures/AnalyticalvsBE_Precursor_Error.png}
%\caption{IQS method solution process}
\label{fig:IQS}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=0.99\linewidth]{figures/heterogeneous_results.png}
%\caption{IQS method solution process}
\label{fig:IQS}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=0.9\linewidth]{figures/heterogeneous_convergence.png}
%\caption{IQS method solution process}
\label{fig:IQS}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=\linewidth]{figures/heterogeneous_YAK.png}
%\caption{IQS method solution process}
\label{fig:IQS}
\end{figure}
