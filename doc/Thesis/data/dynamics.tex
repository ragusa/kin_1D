...
\caption{LRA benchmark geometry with region assignment \cite{ANL_BPB}}
...
\begin{table}[!htbp]
    \centering
    \caption{LRA benchmark initial two-group constants \cite{ANL_BPB} \label{tab:lra-xs}}
    \resizebox{\textwidth}{!}{
...
\caption{LRA baseline temperature and power profile \cite{PrinceMC2017}}
...
\caption{LRA baseline spacial power profile at $t=1.44 s$ \cite{PrinceMC2017}}
...
\end{subfigure}
\caption{LRA error convergence plots \cite{PrinceMC2017}}
\end{figure}

\begin{figure}[htbp!]
\centering
\includegraphics[width=\linewidth]{\FiguresDir/lra_mp.png}
\caption{Error plot with various temperature updates per macro step \cite{PrinceMC2017}}
\label{fig:mp}
\end{figure}
...
\caption{Dynamical time scale for LRA benchmark \cite{PrinceMC2017}}
\label{fig:LRAtc}
\end{figure}
...
\end{subfigure}
\caption{Top quarter view of Transient-15 mesh \cite{mammoth}}
...
\centering
\begin{subfigure}[!htbp]{0.49\textwidth}
\includegraphics[width=\textwidth]{\FiguresDir/Tran15_mesh_fine_zoom.png}
\caption{Explicit meshing of air channels}
\label{fig:Tran15_mesh_fine_zoom}
\end{subfigure}
\begin{subfigure}[!htbp]{0.49\textwidth}
\includegraphics[width=\textwidth]{\FiguresDir/Tran15_mesh_homo_zoom.png}
\caption{Fully homogenized fuel elements}
\label{fig:Tran15_mesh_homo_zoom}
\end{subfigure}
\caption{Top single block view of Transient-15 mesh \cite{mammoth}}
...
\caption{Transient-15 core power profile at peak power \cite{PrinceMC2017}}
\label{fig:Tran15}
\end{figure}
...
&+ 2.8369\times 10^{-3}T -1.009\times 10^{-2} \ (J/g/K)
\label{eq:cp}
\end{align}
...
\caption{Transient-15 total power and average temperature profile during transient \cite{PrinceMC2017}}
...
\caption{Dynamical time scale for the Transient-15 example \cite{PrinceMC2017}}
\label{fig:tran15tc}
\end{figure}
