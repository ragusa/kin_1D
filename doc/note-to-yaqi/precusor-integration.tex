...
\be
\int_{t_n}^{t_{n+1}} C(t')e^{\lambda t'} dt' = \int_{t_n}^{t_{n+1}} \beta\nu\Sigma_f(t')\varphi(t') p(t')e^{\lambda t'}dt'
\ee
...
$\beta\nu\Sigma_f(t')\varphi(t')$) is simple. We just need to agree what to do with beta.
