...
\ee
The factorization is not an approximation. Reporting it in the flux and precursor equations yields the following equations
for the shape and the precursors:
\begin{align}
